...
namespace PowerSDR
{
	public class FWCEEPROM
	{
		...
		public static void WriteRX2Level(float[][] table)
		{
			WriteRX2CalDateTime();			
			Band[] bands = { Band.B160M, Band.B80M, Band.B60M, Band.B40M, Band.B30M, Band.B20M,
							   Band.B17M, Band.B15M, Band.B12M, Band.B10M, Band.B6M };
		...
		public static bool CheckRX2Image()
		{
			...
			WriteRX2Image(gain_table, phase_table);
		...
		public static void WriteRX2Image(float[] gain_table, float[] phase_table)
		{
			WriteRX2CalDateTime();
			Band[] bands = { Band.B160M, Band.B80M, Band.B60M, Band.B40M, Band.B30M, Band.B20M,
							   Band.B17M, Band.B15M, Band.B12M, Band.B10M, Band.B6M };
